...
export default async function AdminPage(){
  ...
  const[{data:profile},{data:assets},{data:places},{data:documents},{data:guides},{data:problems}]=await Promise.all([
